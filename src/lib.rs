...
#[derive(Debug)]
pub struct NeoPacketProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoPacketProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoPacket processing");
    
    let mut processor = NeoPacketProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoPacketProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoPacketProcessor::new(false);
